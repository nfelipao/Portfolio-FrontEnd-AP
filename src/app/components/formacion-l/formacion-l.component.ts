...
import { faCalendar, faEdit, faTrash, faPlus } from '@fortawesome/free-solid-svg-icons';
import { Education } from 'src/app/model/education';
import { FormacionService } from 'src/app/servicios/formacion.service';

@Component({
  selector: 'app-formacion-l',
  templateUrl: './formacion-l.component.html',
  styleUrls: ['./formacion-l.component.css']
})
export class FormacionLComponent implements OnInit {
